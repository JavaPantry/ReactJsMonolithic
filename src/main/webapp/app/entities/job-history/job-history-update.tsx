...
export class JobHistoryUpdate extends React.Component<IJobHistoryUpdateProps, IJobHistoryUpdateState> {
  ...
  jobUpdate = element => {
    ...
    for (const i in this.props.jobs) {
      if (id.toString() === this.props.jobs[i].id.toString()) {
        this.setState({
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : jobHistory} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput type="select" className="form-control" name="jobId" onChange={this.jobUpdate}>
                    <option value="" key="0" />
                    {jobs
                ...
                <AvGroup>
                  ...
                  <AvInput type="select" className="form-control" name="employeeId" onChange={this.employeeUpdate}>
                    <option value="" key="0" />
                    {employees
